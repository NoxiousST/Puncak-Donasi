                    ...
                    {data.children.map((it) => (
                        <div className={"table-row space-y-5"}>
                            <div className={"table-cell w-1/12 justify-end text-end"}>
                                <div className={"min-w-fit text-nowrap rounded-full bg-gradient-to-br from-rose-500 to-rose-600 px-3 py-2 font-semibold shadow-lg shadow-rose-500/70"}>{it.time}</div>
                            </div>
                            ...
                            <div className={"grid w-[36rem] gap-3 py-2"}>
                                <div className={"flex items-center gap-4"}>
                                    ...
                                    <span className={"text-lg font-semibold text-rose-500"}>{it.status}</span>
                                </div>
